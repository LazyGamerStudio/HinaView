        ...
        match command {
            ...
            AppCommand::NavigateLast => {
                ...
                if is_pressed {
                    ...
                    {
                        // In RTL mode, the left page is the last; in LTR, the right page is the last.
            ...
            AppCommand::SetFitScreen => {
                if is_pressed {
                    ...
                    self.settings_state.layout_mode = crate::settings::LayoutModeSetting::Single;
            ...
            AppCommand::SetVerticalScrollMode => {
                if is_pressed && !is_repeat {
                    self.apply_layout_mode_transition(crate::types::LayoutMode::VerticalScroll);
                    self.settings_state.layout_mode =
                        crate::settings::LayoutModeSetting::VerticalScroll;
                    let message = self
                        .localizer
            ...
            AppCommand::CycleFitWidthHeight => {
                if is_pressed && !is_repeat {
                    self.cycle_fit_width_height();
                }
            }
            AppCommand::MovePageToTrash => {
                if is_pressed && !is_repeat {
                    self.move_current_page_to_trash();
                }
            }
        }
    }
