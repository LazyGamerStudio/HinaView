    ...
    pub fn find_neighbor(
        ...
        while visited_count < len {
            ...
            if (step > 0 && check_idx < current_idx as i32)
                || (step < 0 && check_idx > current_idx as i32)
            {
                looped = true;
            }
            ...
            } else if let Some(name) = original_path.file_name().and_then(|n| n.to_str()) {
