...
pub struct LangCommand {
    ...
    pub set_vertical_scroll_mode: String,
    pub cycle_fit_width_height: String,
    pub move_page_to_trash: String,
}
...
pub struct LangToast {
    ...
    pub file_moved_to_trash: String,
    pub file_move_to_trash_failed: String,
}
...
impl Localizer {
        ...
        if let Ok(entries) = std::fs::read_dir(lang_dir) {
            for entry in entries.flatten() {
                if entry.path().extension().and_then(|s| s.to_str()) == Some("json")
                    ...
                    && let Ok(data) = serde_json::from_str::<LangMetaOnly>(&content)
                {
        ...
        LangData {
            ...
            ui: LangUi {
                ...
                shortcuts_list: LangShortcuts {
                    ...
                    move_to_trash: "Ctrl+Backspace / Ctrl+Delete : Move to trash".to_string(),
            ...
            toast: LangToast {
                ...
                file_moved_to_trash: "Page moved to trash.".to_string(),
                file_move_to_trash_failed: "Failed to move page to trash: {0}".to_string(),
            },
            command: LangCommand {
                ...
                set_vertical_scroll_mode: "Switch to Webtoon Mode".to_string(),
                cycle_fit_width_height: "Toggle Fit Width/Height".to_string(),
                move_page_to_trash: "Move page to trash".to_string(),
            },
        }
    }
    ...
    pub fn file_moved_to_trash(&self) -> &str {
        &self.data.toast.file_moved_to_trash
    }

    pub fn file_move_to_trash_failed(&self, error: &str) -> String {
        self.data
            .toast
            .file_move_to_trash_failed
            .replace("{0}", error)
    }
    ...
    pub fn command_name(&self, cmd_key: &str) -> &str {
        match cmd_key {
            ...
            "set_vertical_scroll_mode" => &self.data.command.set_vertical_scroll_mode,
            "cycle_fit_width_height" => &self.data.command.cycle_fit_width_height,
            "move_page_to_trash" => &self.data.command.move_page_to_trash,
            _ => "",
        }
    }
}
